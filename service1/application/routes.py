...
def gen():
    mainIngredient_response = requests.get("http://localhost:5001/mainIngredient")
    oilIngredient_response = requests.get("http://localhost:5002/oilIngredient")
    benefit_response = requests.post("http://localhost:5003/benefit", data = mainIngredient_response.text)
